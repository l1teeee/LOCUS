...
<body > 
    ...
    <div class="contenedoor">
        <header>
            ...
            <nav>
                ...
                <a class="nave" href="categorias/menu-categorias.php" >Menú Categorias</a>
                <a class="nave" href="registrar/registrar.php" >Registrarse</a>
                <input type="checkbox" id="btn-modal">
	            <label for="btn-modal" class="lbl-modal">Iniciar Sesión</label>
                <div class="modal">
        ...
        <section class="libritoo">
            <section class="destaK">
                    <div class="capa">
                        <h4>1</h4>
                        <h3>Innovación</h3>
                        <p style="text-align: justify;">Como originalidad, innova en el mundo de los libros creando tus propios escritos y darlos a conocer a la
                           comunidad.
                        </p>
                    </div>
            </section>
            <section class="destaK">
                <div class="capa">
                    <h4>2</h4>
                    <h3>Creatividad</h3>
                    <p style="text-align: justify;">Explota tu creatividad diseñando, escribiendo y publicando tus escritos a tu gusto.</p>
                </div>
            </section>
            <section class="destaK">
                <div class="capa">
                    <h4>3</h4>
                    <h3>Imaginación</h3>
                    <p style="text-align: justify;">Explora los límites de tu imaginación con tus creaciones que jamas han sido contadas por otros.</p>
                </div>
            </section>
    ...
    <section class="footer">
        ...
        <ul class="idioma">
            ...
            <a href="INGLES/index.php"><p class="textu">Ingles</p></a>
        </ul>
    </section>
</body>
</html>

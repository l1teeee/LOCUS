        ...
        <form action="<?php echo $dir; ?>" method="POST" onsubmit="return validar();">
            <div class="form">
                ...
                <div class="input">
                    ...
                    <div class="inputBox3">
                        <a class="ini" href="iniciar.php">Iniciar Sesión</a><br/>
                        <a class="ini" href="../locusPerfiles/vista/vistaMostrar.php">Ver Usuario</a><br/>
                        <a class="ini" href="../locusPerfiles/vista/vistaMods.php">Ver Moderadores</a><br/>
                    </div>
                </div>

...
<body>
    ...
    <section class="defini">
        <div class="definicion">
            ...
            <h2>The style of the romances is simple and suggestive. Frequently, the action is interrupted so that the mystery is greater. Repetitive formulas and parallels abound. The most prestigious themes in romances are the vassal's love and rebellion against his lord.</h2>
        </div>
    </section>

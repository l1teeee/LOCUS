...
<body>
        ...
        <header>
            ...
            <section class="menu">
                <section class="panel-it">
                    <article id="items1" style="font-family: arial;"><a href="<?php echo $libro; ?>">Upload Books</a></article>
    ...
    <section class="defini">
        <div class="definicion">
            <h2 id="tit">Fantasy</h2>
            <h2>Artistic fiction genre in which the main elements of the plot are imaginary, unreal and supernatural.</h2>
        </div>
    </section>

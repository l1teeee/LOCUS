...
<body>
    ...
    <section class="defini">
        <div class="definicion">
            <h2 id="tit">Action</h2>
            <h2>
                The main objective of the action genre is to show fights, or it can show 
                shootings where any kind of weapon is used, pistols, submachine guns or in more extreme cases,

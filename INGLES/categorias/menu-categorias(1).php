...
<html lang="es">
    ...
    <body>
        ...
        <section class="destaK">
                <div class="figure">
                <a href="Terror.php"><img src="imagenesCategorias/Imagenes Cat menu/Terror.jpg" class="imgd"></a>
                    <div class="capa">
                        <a href="Terror.php">
                        <h3>Terror</h3>
            ...
            <section class="destaK">
                <div class="figure">
                <a href="Romance.php"><img src="imagenesCategorias/Imagenes Cat menu/AMOR.jpg" class="imgd"></a>
                    <div class="capa">
                        <a href="Romance.php">
                        <h3>Romance</h3>
            ...
            <section class="destaK">
                <div class="figure">
                <a href="Fantasia.php"><img src="imagenesCategorias/Imagenes Cat menu/fanta.jpeg" class="imgd"></a>
                    <div class="capa">
                        <a href="Fantasia.php">
                        <h3>Fantasy</h3>
            ...
            <section class="destaK">
                <div class="figure">
                <a href="cienciaFiccion.php"><img src="imagenesCategorias/Imagenes Cat Menu/fiction.jpg" class="imgd"></a>
                    <div class="capa">
                        <a href="cienciaFiccion.php">
            ...
            <section class="destaK">
                <div class="figure">
                <a href="Aventura.php"><img src="imagenesCategorias/Imagenes Cat menu/aventura_.jpg" class="imgd"></a>
                    <div class="capa">
                        <a href="Aventura.php">
                        <h3>Adventure</h3>
            ...
            <section class="destaK">
                <div class="figure">
                <a href="Infantiles.php"><img src="imagenesCategorias/Imagenes Cat menu/infantiles.jpg" class="imgd"></a>
                    <div class="capa">
                        <a href="Infantiles.php">
                        <h3>Children</h3>
            ...
            <section class="destaK">
                <div class="figure">
                <a href="Accion.php"><img src="imagenesCategorias/Imagenes Cat menu/accion.jpg" alt="Acción"></a>
                    <div class="capa">
                        <a href="Accion.php">
                        <h3>Action</h3>

...
<body >
    ...
    <div class="contenedoor">
        <header>
            ...
            <nav>
                ...
                <a class="nave" href="../subir_libro/vista/vistaLibro.php" >Upload Books</a>
        ...
        <section class="libritoo">
            <section class="destaK">
                    <div class="capa">
                        <h4>1</h4>
                        <h3>Innovation</h3>
                        <p>Innovate in the books world creating your own writings 
            ...
            <section class="destaK">
                <div class="capa">
                    <h4>2</h4>
                    <h3>Creativity</h3>
                    <p>Exploit your creativity by designing, writing and publishing your writing as you want.</p>
                </div>
            </section>
            <section class="destaK">
                <div class="capa">
                    <h4>3</h4>
                    <h3>Imagination</h3>
                    <p>Explore your imagination limits with your creations that have never been told.</p>
                </div>
            </section>
    ...
    <section class="services" >
        <section class="container">
            <section class="serviceBx">
                ...
                <p> With LOCUS website, which was created as a project to satisfy the needs to be useful to the society by 
    ...
    <section class="footer">
        ...
        <ul class="idioma">
            ...
            <a href="../../login/index.php?"><p class="textu">Spanish</p></a>
        </ul>
    </section>
</body>
</html>

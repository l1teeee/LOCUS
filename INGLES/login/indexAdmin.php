...
<body >
    ...
    <div class="contenedoor">
        <header>
            ...
            <nav>
                ...
                <a class="nave" href="../Perfiles/vista/vistaMostrar.php" >View Users</a>
                <a class="nave" href="../subir_libro/vista/v_admin.php" >View Reports</a>
    ...
    <section class="footer">
        ...
        <ul class="idioma">
            ...
            <a href="../../login/indexAdmin.php"><p class="textu">Spanish</p></a>
        </ul>
    </section>
</body>
</html>

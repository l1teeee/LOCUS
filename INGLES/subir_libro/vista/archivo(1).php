                ...
                <header>
                    <section class="menu">
                        ...
                        <section class="panel-it">
                            <article id="items"><a href="vistaLibro.php">Upload your book</a></article>
                    ...
                    foreach($archivos as $archivo){//corchete
                        ...
                        <div class="comentarios">
                            <form method="POST" onsubmit="return validar();" action="../controlador/ctrlComentario.php?id=<?php echo $archivo['id']; ?>" enctype="multipart/form-data" >
                                <a name="comentarios"><h1>COMMENTS</h1></a>

                                <div class="text">
                                    <i class="fas fa-user-circle"></i>
                                    <textarea name="comentario" placeholder="Add a comment..." id="comentarioss"></textarea>
                                </div>

               ...
               <header>
                    ...
                    <section class="menu">
                        <section class="panel-it">
                            <article id="items1"><a href="vistaMoney.php">Books to monetize</a></article>
                            <article id="items1"><a href="vmod_pend.php">Pending books</a></article>
                            <article id="items1"><a href="vistaLista.php">List</a></article>

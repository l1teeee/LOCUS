...
<section class="incio">
    ...
    <center><h1> Monetization requests </h1></center>
    ...
    <?php
        ...
        if($cont==0){
            ?>
                <center><h4> Come back later, there are no requests. </h4></center>
            <?php
        } else {
            $libros = $dao->L_money();
    ?>
        ...
        <table> 
            ...
            foreach($libros as $l){
                ...
                <?php
                  ...
                  <td class="cuerpo">
                  <div class="inputBox2">
                  <a id="accion"  href="../controlador/ctrlMod.php?libro=<?php echo $l['id']?>&accion=moneyA&megusta=<?php echo $l['megusta']?>&user=<?php echo $l['usuario']?>&mone=<?php echo $l['monetizacion']?>&actual=<?php  echo $ac['dinero']?>">Approve</a>
                  </div>
                  <div class="inputBox2">
                  <a id="accion" href="../controlador/ctrlMod.php?libro=<?php echo $l['id'] ?>&accion=moneyR">Reject</a>
                  </div>
              </td>
              </tr>

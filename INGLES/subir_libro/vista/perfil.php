...
<body>
    ...
    ?>
    <footer class="info">
    <a href="../../Perfiles/controlador/ctrlUsuario.php?nombreUsu=<?php echo $_SESSION['usu'];?>&accion=modificar"><p id="PER">Edit Profile<i class="fas fa-pen"></i></p></a><a href="../../Perfiles/controlador/ctrlUsuario.php?nombreUsu=<?php echo $_SESSION['usu'];?>&accion=foto"><p id="PER">Edit Picture<i class="fas fa-pen"></i></p></a>
    </footer>
  </div>
  ...
  <?php
    ...
    foreach($usus as $usu){
      ...
      <section class="publicas">
        ...
        <div class="libro">
          <h1 id="port">Coverpage:</h1>
          <img src="../portadas/<?php echo $usu['portada'];?>" alt="" class="porta">
          <section class="publi">
            <h1>Title: <?php echo $usu['titulo'];?></h1>
            
            <h1>Description: <?php echo $usu['descripcion'];?></h1>
            
            <h1>Categorie: <?php echo $usu['categoria'];?></h1>
            
            <h1>Book: <a  href="../vista/archivo.php?id=<?php echo $usu['id']?>"><i style="color:#fff " class="fas fa-file-pdf"></i></a></h1>
            ...
            <?php
              ...
              if ($usu['monetizacion'] == "No" && $usu['megusta'] > 10){
                ?>
                    <p id="money">You can monetize</p>
                <?php
              } else if ($usu['monetizacion'] == "No"){
                ?>
                    <p id="money"> Still can not monetize, likes needs to be higher than 10 </p>
                    
                <?php
                
              } else if ($usu['monetizacion'] == "Pendiente") {
                 ?>
                    <p id="money">Pending to approve monetization</p>
                <?php
              } else if ($usu['monetizacion'] == "Si"){
                ?>
                    <p id="money">Monetizing approved</p>
                <?php
              }

              if ($usu['estado'] == "Pendiente"){
                ?>
                  <p id="money">This book is not published, yet</p>
                <?php
              }else{
                ?>
                <p id="money">This book is already published</p>
              <?php
              }
              ?>
      ...
      <a href="../vista/editarLibro.php?usu=<?php echo $u ?>&id=<?php echo $usu['id']?>"><p id='PER'>Edit book<a href='#'><i id="icon" class="fas fa-pen"></i></a></p></a>
       
      <a href="../vista/archivo.php?id=<?php echo $usu['id']?>"><p id='PER'>View book<a href='#'><i id='icon' class='fas fa-eye'></i></a></p></a>
      <a href='../controlador/ctrlMod.php?libro=<?php echo $usu['id']; ?>&accion=monetizar&megusta=<?php echo $usu['megusta'] ?>&mone=<?php echo$usu['monetizacion']; ?>&nombreUsu=<?php echo $usu['usuario'];?>'><p id='PER'>Monetize <a href='../controlador/ctrlMod.php?libro=<?php echo $usu['id'] ?>&accion=monetizar'><i class='fas fa-comment-dollar'></i></a></p></a>

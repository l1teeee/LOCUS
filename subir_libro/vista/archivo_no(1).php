                ...
                <header>
                    <section class="menu">
                        ...
                        <section class="panel-it">
                            <article id="items"><a href="../../categorias/menu-categorias.php">Menu Categorias</a></article>
                            <article id="items"><a href="vistaLibro.php">Subir Libro</a></article>
                            <article id="items"><a href="perfil.php">Mi perfil</a></article>
                        ...
                        <div class="comentarios">
                            <form method="POST" action="" enctype="multipart/form-data">
                                ...
                                <i class="fas fa-user-circle"></i>
                                    <textarea onclick="mensajeclick()" name="comentario" placeholder="Agregar comentario...." ></textarea>
                                </div>

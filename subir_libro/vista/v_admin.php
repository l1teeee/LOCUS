...
<center><h1>Listado de Reportes</h1></center>
<?php
require_once "../modelo/daoReport.php";
    ...
    if($cont==0){
        echo "<center><h4>No hay reportes por el momento, regresa luego</h4></center>";
    } else {
?>
    <center>
    <table class="table caption-top">
        <tr>
            <td class="titulos">LIBRO</td>
    ...
    <?php
        ...
        foreach($reportes as $reporte){
            ...
            <td class="cuerpo">
                <div class="inputBox2">
                <a id="accion" href="../controlador/ctrlMod.php?id=<?php echo $libro?>&accion=Libro">Eliminar libro</a>
                </div>
                <div class="inputBox2">
                <a id="accion" href="../controlador/ctrlMod.php?report=<?php echo $reporte['idReport'] ?>&accion=Reporte">Eliminar Reporte</a>
                </div>
            </td>

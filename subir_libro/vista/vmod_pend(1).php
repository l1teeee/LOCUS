...
<html>
    <head>
        <meta charset="UTF-8">
        <title>PENDIENTES MODERADOR</title>
               ...
               <header>
                    ...
                    <section class="menu">
                        <section class="panel-it">
                            <article id="items1"><a href="vistaLista.php"><h5>Ver Lista</h5></a></article>
    ...
    <header></header>
        <center><h1>Libros pendientes</h1></center>
        <br>
        ...
        // echo $cont;
            ...
            if($cont==0){
               echo "<center><h4>No hay libros por aprobar, regresa luego</h4></center>";
            } else {
                ?>
                ...
                <?php
                    ...
                    foreach($libros as $libro){
                        ...
                        <td class='cuerpo'>
                        <div class="inputBox2">
                        <a id="accion" href="../controlador/ctrlMod.php?id=<?php echo $libro['id']?>&accion=Aprobar"> Aprobar </a>
                        </div>
                        <div class="inputBox2">
                        <a id="accion" href="../controlador/ctrlMod.php?id=<?php echo $libro['id']?>&accion=Rechazar"> Rechazar </a>
                        </div>
                        </td>
                    <form>
                    </tr>

...
<body>
    ...
    <section class="defini">
        <div class="definicion">
            <h2 id="tit">Infantiles</h2>
            <h2>El genero infantil tiene como objetivo, enseñarle a los niños por medio de los dibujos coloridos, pocas palabras y muchas ilustraciones e historias no tan profundas</h2>
        </div>
    </section>

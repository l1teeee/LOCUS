...
<body>
    ...
    <section class="defini">
        <div class="definicion">
            <h2 id="tit">Ciencia Ficcion</h2>
            <h2>Denominación popular con que se conoce a uno de los géneros derivados de la Literatura de Ficción, junto con la literatura fantástica y la narrativa de terror.</h2>
        </div>
    </section>
